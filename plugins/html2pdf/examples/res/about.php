...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
  ...
  <br><br><br><br><br>
  <div class="note">
    HTML2PDF est un convertisseur de code HTML vers PDF écrit en PHP5, utilisant la librairie
    <a href="http://tcpdf.org">TCPDF.</a><br>
    <br>
...
<page pageset="old">
  ...
  <ul class="main">
    ...
    <li>&lt;code&gt;, &lt;pre&gt;</li>
    <li>&lt;div&gt; :&nbsp;<div style="border: solid 1px #AADDAA; background: #DDFFDD; text-align: center; width: 50mm">
        exemple de DIV
      </div>
    </li>
...
<page pageset="old">
  ...
  <ul class="main">
    ...
    <li>Elle ne permet généralement pas la conversion directe d'une page HTML en PDF, ni la conversion du résultat d'un
      WYSIWYG en PDF.
    </li>
    <li>Cette librairie est là pour faciliter la génération de documents PDF, pas pour convertir n'importe quelle page
      HTML.
    </li>
