...
function ajaxMakeADay() {
  ...
  ajaxAction({"action": "ajaxMakeADay", "controller": "ControllerMake"}, data, "#ajax-loader", false, callback);
}
...
function ajaxMakeAComment() {
  ...
  ajaxAction({"action": "ajaxMakeAComment", "controller": "ControllerComment"}, data, "#ajax-loader", false, callback);
}
...
function ajaxMakeAReply(rep_id, com_id) {
  ...
  ajaxAction({"action": "ajaxMakeAReply", "controller": "ControllerComment"}, data, loader, false, callback);
}
...
function ajaxLikeADay(id) {
  ...
  ajaxAction({"action": action, "controller": controller}, $.param({"id": id}), false, false, false);
};
...
function ajaxSearchMore(search, from) {
  ...
  ajaxAction({"action": "ajaxSearchMore", "controller": "ControllerView"},
