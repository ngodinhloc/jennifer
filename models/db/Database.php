<?php
  ...
  abstract class Database implements DatabaseInterface {
     ...
     * @see \db\driver\DriverInterface::getFoundRows()
     */
     ...
     * @return array
     * @see \db\driver\DriverInterface::resultToArray()
     */
     ...
     * @param string $sql
     * @return string
     * @see \db\driver\DriverInterface::escapeString()
     */
     ...
     * @param $act
     * @return string
     * @see \db\driver\DriverInterface::checkDB()
     */
