    ...
    public function getPhotoByYearMonth($year, $month) {
      ...
      foreach ($result as $row) {
        ...
        foreach ($photos as $i => $name) {
          $photo_full = Common::getPhotoName($name, PHOTO_FULL_NAME);
          $photo_title = Common::getPhotoName($name, PHOTO_TITLE_NAME);
          $photo_thumb = Common::getPhotoName($name, PHOTO_THUMB_NAME);
